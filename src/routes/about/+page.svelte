...
<svelte:head>
	<title>AniMuyi &bull; About</title>
	<html lang="en" />
    <!-- Google tag (gtag.js) -->
...
<br>
<br>
<p class="centerbold" style="color:#ac0202;">**Disclaimer: We do not store any data on our servers. We only display data that is freely available online from third-party sources. We are not responsible for the accuracy, completeness, or legality of the data displayed on our website.**</p>
<hr>
<h1 class="center" id="about">About Us</h1>
            <div class="content">
                    <br>
                    <h2 class="center">What is AniMuyi and what is our mission?</h2>
                    ...
                    <p class="center">Our mission is Anime for All</p>
                    <br>
